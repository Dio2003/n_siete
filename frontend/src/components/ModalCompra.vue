                ...
                <form action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <!-- titulo -->
                            <p class="text-center mb-3  border-top border-bottom modal-title fs-5 p-2 fw-semibold">Cargar datos de la Factura Compra</p>
                            <!-- SUCURSAL -->
                            ...
                            <div class="card col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <!-- Imputar -->
                                    <div class="col-md-6 mb-3 text-start">
                                        <label for="imputada" class="form-label">Imputar</label>
                                        <select class="form-select" name="imputada" id="imputada">
                                            <option value="0">Seleccionar</option>
