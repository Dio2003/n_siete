<template>
    <div class="venta">
        ...
        <Siderbar />
        <!-- MODAL -->
        <ModalVenta v-if="mostrarModal" @cerrar="cerrarModal" :tituloModal="tituloModal"/>
        <!-- Contenido Principal -->
            ...
            <div class="d-flex flex-wrap align-items-center gap-2 mb-3 pt-3 pb-3 color-div pe-3 ps-3 rounded shadow-sm">
                ...
                <div class="d-flex align-items-center gap-2 flex-grow-1">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdown03" id="filterDropdown">
                        ...
                        <li><a class="dropdown-item" data-col="2">Cliente RUC</a></li>
...
import ModalVenta from '@/components/ModalVenta.vue'
